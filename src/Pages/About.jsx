        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              I am a passionate and curious individual who loves exploring new ideas and creating meaningful connections. Driven by ambition and a positive outlook, I embrace every opportunity to learn and grow. I believe in balancing hard work with a genuine appreciation for life’s experiences. My goal is to inspire others and make a lasting, positive impact wherever I go.
            </p>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1Ag9zL01NEvuWno6I9JuMhaCj1JZe2Hek/view?usp=sharing" className="w-full lg:w-auto" target="_blank">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
