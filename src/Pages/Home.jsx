...
const WORDS = ["BSc CS (SE) Graduate", "Tech Enthusiast", "Problem Solver"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Python", "Java"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/DishanSE" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/anandaraja-dishan/" },
  { icon: Instagram, link: "https://www.instagram.com/raj_dishan/?igsh=ZHp3YXBwajhmbzV0#" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  A dedicated and passionate software engineering graduate. Welcome to my portfolio.
                </p>
