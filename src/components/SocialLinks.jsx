...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/anandaraja-dishan/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@raj_dishan",
    icon: Instagram,
    url: "https://www.instagram.com/raj_dishan?igsh=ZHp3YXBwajhmbzV0",
    color: "#E4405F",
  ...
  },
  {
    name: "Gmail",
    displayName: "Gmail",
    subText: "ardishan34@gmail.com",
    icon: Mail,
    url: "mailto:ardishan34@gmail.com",
    color: "#ffffff",
    gradient: "from-[#333] to-[#24292e]",
  },
];
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* Third Row - GitHub & Gmail */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[github, mail].map((link, index) => (
            <a
              key={link.name}
              href={link.url}
